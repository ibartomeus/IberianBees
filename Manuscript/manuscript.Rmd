...
```{r echo=FALSE, fig.align='center', out.width="70%", fig.cap="Figure 1"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap="Figure 2",out.width="70%"}
...
```{r echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Figure 3", message=FALSE, warning=FALSE, cache=FALSE}
# Prepare top 20 records

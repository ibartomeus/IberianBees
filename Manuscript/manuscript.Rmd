...
Las abejas (Hymenoptera, Apoidea) son un grupo muy diverso de especies con más de 20.000 especies descritas en el mundo (@Ascher). Debido a las condiciones climáticas de la Península Ibérica, esta se caracteriza por ser uno de los puntos calientes de diversidad a nivel mundial con más de 1000 abejas descritas hasta la fecha (@Ortiz). A pesar de la gran diversidad de abejas Ibéricas, conocemos muy poco de su ecología
y distribución. Paradójicamente las abejas son un un grupo clave que desarrolla una función vital para la moyoría de ecosistemaas terrestres, la polinización de miles de plantas (@ollerton) incluyendo a la mayoría de cultivos (@klein). Además el cambio debido al impacto del ser humano esta dando lugar al declive de algunas de sus poblaciones (@goulson). No obstante, la respuesta de las abejas al cambio global es heterogénea en el espacio y taxonomicámente. Es decir, existen áreas que están sufriendo un decaimiento poblacional drástico (@Burkle) mientras que otras se mantienen bien conservadas (@Herrera2020) y mientras que algunas especies se encuntra al borde de la extinción (@Cameron), otras se encuentran incluso prosperando (@Ruso). Una mejor descripción de la distribución de las abejas sobre su distribución, preferencia de hábitat, fenología, o tendencias históricas en la Península Ibérica requerirían información de dónde y cuándo las especies aparecen.  
